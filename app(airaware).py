...
Original file is located at
    https://colab.research.google.com/drive/1mH3StGnBe620vJKzrI4J2MqJx_v_89SE
"""
...
#     # CSV UPLOAD
#     # --------------------------------------------------
#     uploaded_file = st.file_uploader("Upload Air Quality CSV (e.g., Kolkata.csv)", type=["csv"])
# 
#     if uploaded_file:
...
# 
#     else:
#         st.warning("Please upload Kolkata.csv or any Air Quality CSV file to continue.")
#
